...
// import { FaUser, FaLock, FaEye, FaEyeSlash, FaEnvelope, FaGoogle, FaGithub, FaTwitter } from 'react-icons/fa';
...
//           <p className="text-gray-400">Sign up to get started with our platform</p>
//         </div>
...
//                   I agree to the{' '}
//                   <button type="button" className="text-blue-400 hover:text-blue-300 transition duration-200">
//                     Terms and Conditions
//                   </button>{' '}
//                   and{' '}
//                   <button type="button" className="text-blue-400 hover:text-blue-300 transition duration-200">
